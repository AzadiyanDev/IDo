...
const FA_TEXT: Record<string, string> = {
  ...
  'Installed': 'نصب شده',
  'Update available': 'به‌روزرسانی آماده است',
  'A new version is ready. Update now to clear cached files and load the latest fixes.': 'نسخه جدید آماده است. برای پاک شدن فایل‌های کش‌شده و دریافت آخرین اصلاحات، همین حالا به‌روزرسانی کن.',
  'Update': 'به‌روزرسانی',
  ...
  'Move unfinished tasks?': 'انتقال تسک‌های انجام‌نشده؟',
  'Move to today': 'انتقال به امروز',
  'Not now': 'فعلا نه',
  'Moving tasks...': 'در حال انتقال تسک‌ها...',
  'Could not move tasks.': 'انتقال تسک‌ها ناموفق بود.',
