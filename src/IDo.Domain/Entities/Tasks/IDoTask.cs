...
public sealed class IDoTask : SoftDeletableEntity
{
    ...
    public Guid? PendingAssigneeUserId { get; set; }
    public User? PendingAssigneeUser { get; set; }
    ...
    public ProjectTaskAssignmentStatus AssignmentStatus { get; set; } = ProjectTaskAssignmentStatus.None;
